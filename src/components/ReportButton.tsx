...
// The dialog traps nothing fancy — it closes on Escape, on backdrop click, and
// on Cancel, and restores focus to the trigger so keyboard users aren't lost.
  ...
  return (
    <>
      <button
        ...
        onClick={() => (isLoggedIn ? setOpen(true) : setError("login"))}
