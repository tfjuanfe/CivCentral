...
export type ReportTargetType = "comment" | "entry";
export type ReportStatus = "open" | "resolved" | "dismissed";

export const REPORT_DETAILS_MAX = 1000;

// Snapshot length kept in the report so archivists can judge it even after the
// original content is deleted.
export const REPORT_EXCERPT_MAX = 500;

export function excerpt(text: string, max = REPORT_EXCERPT_MAX): string {
